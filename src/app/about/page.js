...
export default function About() {
    return (
        <div className="flex flex-col items-center gap-10">
            ...
            <div className="w-32 h-32 overflow-hidden relative border-zinc-700 border-[3px] bg-black rounded-full">
                <Image alt="Profile Image" fill className="object-contain" src="/profile.png"></Image>
            </div>
